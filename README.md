...
**Twitter-esque** is an android app that allows a user to view their Twitter timeline and post a new tweet. The app utilizes [Twitter REST API](https://dev.twitter.com/rest/public).
...
* [x] User cannot tweet their composed message unless button is blue and enabled.
* [x] User can retweet, favorite, and reply from the timeline as well as the details.
* [x] User can view profile with follower/following count information 
